...
<html lang="en" dir="ltr">
  ...
  <body class="body">
    ...
    <div class="row">
      ...
      <tbody style='space: nowrap;'>
        ...
        if(isset($_POST['search_btn'])){
           ...
           $sql = "SELECT *  FROM postbank_staff WHERE job_status='Resigned' AND (SR_NO LIKE  '%$searchKey%')
          ...
          $sql = "SELECT *  FROM postbank_staff where job_status = 'Resigned' ORDER BY start_date DESC";
          $result = mysqli_query($conn,$sql);
          while ($raw_data = mysqli_fetch_assoc($result)) {
                  $SR_NO = $raw_data['SR_NO'];
                   $Firstname = $raw_data['Firstname'];
    ...
    <?php include('resigned_modal.php');?>
