...
<body>
  <div class="sidebar close">
    <div class="logo-details">
      ...
      <span class="logo_name ms-1" style="font-size: 18px;">Attendee dashboard</span>
    </div>
    <ul class="nav-links">
      <li>
        <a href="attendeedashboard.php?dashboard=<?php
      ...
      <li>
        ...
        <ul class="sub-menu mt-1">
          <li><a class="link_name mt-1" href="#">Events</a></li>

          <li><a href="attendeedashboard.php?book_event" style="font-size:20px;">Book Events</a></li>
  <li><a href="attendeedashboard.php?my_events" style="font-size:20px;">My Events</a></li>
                 <!--in Service-->
...
<li>
  ...
  <section class="home-section mt-2" id="dash_section" >
    <div class="home-content">
      ...
      <span class="text">Attendee Dashboard</span>
    </div>
  </section>
  <div class="row">
  ...
  <div class="col-sm-5 my-2 col-md-9 offset-md-0 mt-3">
    ...
    if (isset($_GET['dashboard'])) {
      ...
      include ('attendee_dashboard.php');
      // code...
    }
