...
<body>
  <div class="sidebar close">
    <div class="logo-details">
      ...
      <span class="logo_name ms-1" style="font-size: 18px;">Vendor dashboard</span>
    </div>
    <ul class="nav-links">
      <li>
        <a href="vendordashboard.php?dashboard=<?php
      ...
      <li>
        ...
        <ul class="sub-menu mt-1">
          <li><a class="link_name mt-1" href="#">Orders</a></li>

          <li><a href="vendordashboard.php?manage_orders" style="font-size:20px;">Manage Orders</a></li>
             ...
             <li>
               ...
               <ul class="sub-menu mt-1">
                 ...
                 <li><a href="vendordashboard.php?orders" style="font-size:20px" >Orders reports</a></li>
