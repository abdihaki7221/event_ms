  ...
  <body class="body" >
        ...
        <!--search btn--->
          <nav class="navbar justify-content-start">
            <div class="text-start " >
              <button   onclick="printDiv('table_in_service')" type="button" name="button" class="btn" style="background-color:#0047AB">
    ...
    <div class="row">
      ...
      <thead class='thead text-white' style='background-color: #0047AB;'>
        ...
        $sql = "SELECT * FROM postbank_staff   ORDER BY start_date DESC";
