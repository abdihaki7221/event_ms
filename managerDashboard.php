...
<body>
  <div class="sidebar close">
    <div class="logo-details">
      ...
      <span class="logo_name ms-1" style="font-size: 18px;">Venue Manager dashboard</span>
    </div>
    <ul class="nav-links">
      <li>
        <a href="managerDashboard.php?dashboard=<?php
      ...
      <li>
        <div class="iocn-link">
          <a href="#">
            ...
            <span class="link_name">Venues</span>
          </a>
          <i class='bx bxs-chevron-down arrow' ></i>
        </div>
        <ul class="sub-menu mt-1">
          <li><a class="link_name mt-1" href="#">Venues</a></li>
          <li><a href="managerDashboard.php?create_venue" style="font-size:20px;">Create Venue</a></li>
          <li><a href="managerDashboard.php?manage_bookings" style="font-size:20px;">View bookings</a></li>
             ...
             <li>
               ...
               <ul class="sub-menu mt-1">
                 ...
                 <li><a href="managerDashboard.php?venue_reports" style="font-size:20px" >Venue reports</a></li>
...
<li>
  ...
  <section class="home-section mt-2" id="dash_section" >
    <div class="home-content">
      ...
      <span class="text">Venue Manager Dashboard</span>
    </div>
  </section>
  <div class="row">
  ...
  <div class="col-sm-5 my-2 col-md-9 offset-md-0 mt-3">
    ...
    if (isset($_GET['create_venue'])) {
      ...
      include ('create_venue.php');
      // code...
    }

    if (isset($_GET['manage_bookings'])) {
    ...
    //  include ('manage_staff.php');
      // code...
  //  }
    if (isset($_GET['venue_reports'])) {

      include ('venue_reports.php');
      // code...
    }
