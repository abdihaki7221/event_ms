        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <a href="event_planner_dashboard.php?inservice"><button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <form action="update_staff_inservice.php" method="POST">
                    ...
                    <div class="modal-footer">
                      <a href="event_planner_dashboard.php?inservice"><button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button></a>
