...
<div class="modal fade" id="terminated_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> Update Staff Details </h5>
                    <a href="event_planner_dashboard.php?terminated"><button type="button" class="close" data-dismiss="modal" aria-label="Close">
                ...
                <form action="update_staff_terminated.php" method="POST">
                    ...
                    <div class="modal-footer">
                      <a href="event_planner_dashboard.php?terminated"><button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button></a>
