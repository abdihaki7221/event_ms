  ...
  $updateCodeQuery = mysqli_query($conn, "UPDATE users SET code=1 WHERE email='$username'");
      ...
      switch ($usertype) {
          case 'planner':
              ...
              exit();
          case 'attendee':
              // Redirect to attendeedashbaord.php for attenders
              $_SESSION['username'] = $username;
            ...
            <div class="col-lg-6 col-md-6 infinity-form-container">
                <div class="col-lg-9 col-md-12 col-sm-9 col-xs-12 infinity-form">
                    ...
                    <div class="text-center text-light">
                        <p>An email verification code has been sent to your email</p>
                    </div>
                    ...
                    <form class="px-3" method="post">
                        ...
                        <!-- Login Button -->
                        <div class="mb-3">
                            <button type="submit" name="confirm" class="btn btn-block">Verify</button>
                        </div>
